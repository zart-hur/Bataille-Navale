...
namespace BatailleNavale.View
{
    ...
    internal class UtilView
    {
        ...
        public static Point ConvertPoints(Point pointIn)
        {
            ...
            pointOut.X = pointIn.X * View.DIMENTION_OF_CELL - View.DIMENTION_OF_CELL;
            pointOut.Y = pointIn.Y * View.DIMENTION_OF_CELL - View.DIMENTION_OF_CELL;
